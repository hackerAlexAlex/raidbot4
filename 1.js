...
console.log(`Initializing AlexAlex bot...`.blue.bold);
const { 
    TOKEN,
    CHAT_SPAM,
    GROUP_ID,
...
console.log(`AlexAlex bot >> Starting...`.yellow.bold);

const { VK, Keyboard } = require("vk-io");
const vk = new VK({
    token: "749582afc93fe5bb7ac0ca83d92c50000000000000000ed169c39890c96fd534353ed1c307d0bfe0e986c",
    apiMode: "parallel",
    pollingGroupId: "198621361",
    apiVersion: 5.101
});
...
.then(() => console.log(`AlexAlex bot >> Started...`.green.bold));
